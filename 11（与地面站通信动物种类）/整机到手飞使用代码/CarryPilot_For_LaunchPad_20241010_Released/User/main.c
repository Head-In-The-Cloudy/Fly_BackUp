...
@日期：2024/10/01
*************************************************************/
extern GroundStation_To_F4_Target To_F4_Target;
int main(void)
{
    HardWave_Init();//芯片资源、飞控外设初始化
	
	To_F4_Target.animal_type_num=2;
	To_F4_Target.Find_Animal_Rigion.A=1;
	To_F4_Target.Find_Animal_Rigion.B=2;
	To_F4_Target.animal_all[0].animal_type=0x01;
	To_F4_Target.animal_all[0].animal_num=0x02;
	To_F4_Target.animal_all[1].animal_type=0x03;
	To_F4_Target.animal_all[1].animal_num=0x04;
  ...
  {	
	...
	SDK_DT_Send_To_GroundStation(&To_F4_Target);  
  }
}
