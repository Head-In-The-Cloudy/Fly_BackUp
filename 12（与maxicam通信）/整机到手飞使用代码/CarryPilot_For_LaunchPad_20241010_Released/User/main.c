...
int main(void)
{
  ...
  {	
	  ...
	  if(Opv_Top_View_Target.flag==1&&(MAP_flag_case_0xA1==0||MAP_flag_case_0xA1==1))  //收到 MAP下的一个 路径
	  {
	  ...
	  else if(Opv_Top_View_Target.flag==1&&MAP_flag_case_0xA1==2)
	  {
